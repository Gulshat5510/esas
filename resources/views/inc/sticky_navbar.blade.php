<nav id="sticky_navbar" class="navbar absolute-top">
  <div class="container">
    <a class="navbar-brand" href="{{ route('index') }}"><img src="{{ asset('images/logo-light.svg') }}" alt="logo"></a>
    ...
    <ul class="navbar-nav ml-auto d-flex d-sm-none text-light">
      <li class="nav-item" id="sticky_menu"><span class="nav-link" onclick="openNav()"><i data-icon="menu"></i></span></li>
    </ul>
  </div>
</nav>